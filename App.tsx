...
/**
 * Ziamap High-Performance Funnel Page
 * Inspired by professional surveying and motorsport aesthetics.
 */

const Logo: React.FC<{ className?: string }> = ({ className = "h-12" }) => {
  const [error, setError] = useState(false);
  
  // Using the direct download link for the PNG logo provided
    ...
    <header className="relative min-h-screen w-full flex items-center justify-center overflow-hidden border-b border-white/10">
      <div className="absolute inset-0 z-0">
        ...
        <div 
          ...
          style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/d/1eED1CoQdazoorHxnk8z3PShFQEcXL-J5")' }}
        ></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-1">
            {[
              { 
                ...
                desc: "The average surveying firm spends over 10 hours weekly organizing field photos and notes after the job is done. That's 520 hours a year—or 13 full work weeks—lost to administrative busywork." 
              },
              { 
                icon: 'photo_camera', 
                title: '1 in 4 Projects', 
                desc: "One in four surveying projects experiences documentation issues—lost photos, mismatched notes, or missing GPS data. These errors lead to client disputes, rework, and liability exposure that could have been avoided." 
              },
              { 
                icon: 'payments', 
                title: '$3,200 Average Cost', 
                desc: "The average cost of a single documentation error—from client disputes to rework—is $3,200 per incident. Most firms experience 2-3 of these incidents per year, costing them nearly $10,000 in preventable losses." 
              }
            ].map((item, idx) => (
...
const Steps: React.FC = () => {
  const feedItems = [
    { 
      num: '01', 
      title: 'ENGAGE', 
      desc: "Open Your Project: Select the project you're working on.",
      img: 'https://lh3.googleusercontent.com/d/1WjdQTFTdg1O_AcFIHeGMiZTMRWTW6z13'
    },
    { 
      num: '02', 
      title: 'CAPTURE', 
      desc: 'Document Your Work: Use the Ziamap app to take photos and add notes.',
      img: 'https://lh3.googleusercontent.com/d/19Zfnt7fC-x_N_Rr5d60bYlUNApcgDZXd'
    },
    { 
      num: '03', 
      title: 'SYNC', 
      desc: "It's Done: Everything is instantly organized in your Evidence Feed and synced with the ZIAMAP desktop app",
      img: 'https://lh3.googleusercontent.com/d/1xBb2g3Wkn6Qjp9aLV-Sb3VEfz_ETzGlS'
    }
  ];
        ...
        <div className="flex flex-col md:flex-row items-center gap-16">
          <div className="flex-1 space-y-8">
            ...
            <p className="text-xl text-slate-400 max-w-lg font-light leading-relaxed">
              We are keeping the beta group small to ensure we can provide personalized support and gather high-quality feedback. Once we hit 25 firms, we will be closing the doors to new members until our public launch.
            </p>
            <ul className="space-y-4">
              {[
                "LOCKED IN FOR 2 YEARS WHEN WE LAUNCH",
                "UNLIMITED PROJECTS, UNLIMITED STORAGE",
                "6 TEST SEATS FOR YOUR TEAM",
          ...
          <div className="flex-1 w-full">
            <div className="bg-[#F0B100] p-12 skew-element">
              <div className="skew-text text-black">
                ...
                <div className="space-y-6 mb-12 border-y border-black/10 py-10">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-center font-motorsport font-bold italic">
                    <div className="text-2xl lg:text-3xl leading-tight">STRAIGHT AND LEVEL PRICING</div>
                    <div className="text-xl lg:text-2xl text-right sm:text-right">$199/MO* $20/SEAT</div>
                  </div>
                  <p className="text-[10px] font-bold uppercase tracking-widest">*locked in for 2 years if paid annually</p>
                </div>
      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center gap-12">
          ...
          <div className="flex flex-wrap justify-center gap-10">
            {['PRIVACY_PROTOCOLS', 'TERMS_OF_SERVICE', 'COMMS_RELAY'].map(link => (
              <a key={link} className="text-xs font-motorsport font-bold tracking-[0.2em] text-slate-400 hover:text-[#F0B100] transition-colors italic" href="#">{link}</a>
            ))}
          </div>
...
export default function App() {
  return (
    <div className="selection:bg-[#F0B100] selection:text-black">
      <Hero />
      <FrictionSection />
      <Steps />
      <Pricing />
